...
Elm.Album.make = function (_elm) {
   ...
   if (_elm.Album.values)
   return _elm.Album.values;
   var _op = {},
   _N = Elm.Native,
   ...
   var SelectArtist = function (a) {
      return {ctor: "SelectArtist"
             ,_0: a};
   };
   var view = F2(function (address,
   model) {
      return function () {
         var artistLink = function (name) {
            return A2($Html.a,
         ...
         _L.fromArray([A2($Html.div,
                      ...
                      _L.fromArray([$Html$Attributes.src(A2($Maybe.withDefault,
                                   "",
                                   $List.head(model.images)))
   ...
   var RegisterData = function (a) {
      return {ctor: "RegisterData"
             ,_0: a};
   };
   var FetchData = {ctor: "FetchData"};
   var init = F2(function (name,
   url) {
      return {ctor: "_Tuple2"
             ,_0: {_: {}
                  ,artists: _L.fromArray([])
                  ,images: _L.fromArray([])
                  ,name: name
                  ,url: url}
             ,_1: $Effects.task($Task.succeed(FetchData))};
   });
   ...
   var decodeAlbum = A5($Json$Decode.object4,
   Model,
   A2($Json$Decode._op[":="],
   "name",
   $Json$Decode.string),
   ...
   $Json$Decode.string),
   A2($Json$Decode.at,
   _L.fromArray(["artists"]),
   $Json$Decode.list(A2($Json$Decode._op[":="],
   "name",
   $Json$Decode.string))),
   A2($Json$Decode.at,
   _L.fromArray(["images"]),
   ...
   "url",
   $Json$Decode.string))));
   var fetchData = function (model) {
      return {ctor: "_Tuple2"
             ,_0: model
             ,_1: $Effects.task($Task.map(RegisterData)($Task.toMaybe(A2($Http.get,
             decodeAlbum,
             model.url))))};
   };
...
Elm.Artist.make = function (_elm) {
   ...
   if (_elm.Artist.values)
   return _elm.Artist.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var SelectAlbum = function (a) {
      return {ctor: "SelectAlbum"
             ,_0: a};
   };
   var view = F2(function (address,
   model) {
      ...
      _L.fromArray([A2($Html.div,
                   ...
                   _L.fromArray([A2($Html.img,
                   _L.fromArray([$Html$Attributes.src(A2($Maybe.withDefault,
                                "http://www.freelanceme.net/Images/default%20profile%20picture.png",
                                $List.head(model.images)))
                                ,$Html$Attributes.$class("img-thumbnail")
                                ,$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                      ,_0: "width"
                   ...
                   _L.fromArray([$Html.text(model.name)
                                ...
                                _L.fromArray([$Html$Attributes.href("#")
                                             ,A2($Html$Events.onClick,
                                             address,
                                             SelectAlbum(model.name))]),
                                _L.fromArray([$Html.text("view albums")]))]))])))]));
   });
   var RegisterData = function (a) {
      return {ctor: "RegisterData"
             ,_0: a};
   ...
   var decodeArtist = A4($Json$Decode.object3,
   Model,
   A2($Json$Decode._op[":="],
   "name",
   $Json$Decode.string),
...
Elm.Main.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var scrollFromBottom = Elm.Native.Port.make(_elm).inboundSignal("scrollFromBottom",
   "Int",
   function (v) {
...
Elm.Search.make = function (_elm) {
   ...
   var SetScroll = function (a) {
      return {ctor: "SetScroll"
             ,_0: a};
   };
   var ArtistAction = F2(function (a,
   b) {
      return {ctor: "ArtistAction"
             ,_0: a
             ,_1: b};
   });
   var AlbumAction = F2(function (a,
   b) {
      return {ctor: "AlbumAction"
             ,_0: a
             ,_1: b};
   });
   ...
   model) {
      return function () {
         var toArtistEntry = F2(function (i,
         artist) {
            return A2($Html.div,
            _L.fromArray([$Html$Attributes.$class("col-xs-3")]),
            _L.fromArray([A2($Artist.view,
            A2($Signal.forwardTo,
            address,
            ArtistAction(i)),
            artist)]));
         });
         var toAlbumEntry = F2(function (i,
         album) {
            return A2($Html.div,
            _L.fromArray([$Html$Attributes.$class("col-xs-3")]),
            _L.fromArray([A2($Album.view,
            A2($Signal.forwardTo,
            address,
            AlbumAction(i)),
            album)]));
         });
         return row(A2($List.append,
         A2($List.indexedMap,
         toAlbumEntry,
         model.albums),
         A2($List.indexedMap,
   ...
   var QueryTypeChange = function (a) {
      return {ctor: "QueryTypeChange"
             ,_0: a};
   };
   ...
   var queryTypeToString = function (queryType) {
      return function () {
         switch (queryType.ctor)
         {case "QueryAlbum":
            return "album";
            case "QueryArtist":
            return "artist";}
   ...
   var searchUrl = function (model) {
      ...
      _L.fromArray([A2(_op["=>"],
                   ...
                   ,A2(_op["=>"],
                   "type",
                   queryTypeToString(model.queryType))]));
   };
   var QueryAlbum = {ctor: "QueryAlbum"};
   var QueryArtist = {ctor: "QueryArtist"};
   var queryTypeFromString = function (queryTypeString) {
      return _U.eq(queryTypeString,
      "artist") ? $Maybe.Just(QueryArtist) : _U.eq(queryTypeString,
      "album") ? $Maybe.Just(QueryAlbum) : $Maybe.Nothing;
   };
   ...
   model) {
      return function () {
         var capitalize = function (str) {
            ...
            $String.toUpper(A2($String.left,
            1,
            str)),
            A2($String.dropLeft,1,str));
         };
         var makeOption = function (queryType) {
            return A2($Html.option,
            _L.fromArray([$Html$Attributes.value(queryTypeToString(queryType))]),
            _L.fromArray([$Html.text(capitalize(queryTypeToString(queryType)))]));
         };
         return A2($Html.div,
         ...
         _L.fromArray([A2($Html.input,
                      ...
                      _L.fromArray([]))
                      ,A2($Html.select,
                      _L.fromArray([$Html$Attributes.value(queryTypeToString(model.queryType))
                                   ,A2($Events.onChange,
                                   address,
                                   QueryTypeChange)]),
                      A2($List.map,
                      makeOption,
                      _L.fromArray([QueryAlbum
                                   ,QueryArtist])))
                      ,A2($Html.button,
                      ...
                      ,$Html.text(model.loading ? "loading..." : "")]));
      }();
   });
   var view = F2(function (address,
   model) {
      ...
      _L.fromArray([bootstrap
                   ,containerFluid(_L.fromArray([A2(inputForm,
                                                address,
                                                model)
                                                ,$Html.text($Basics.toString(model.resultCount))
                                                ,$Html.text(" results")
                                                ,A2(resultsList,
                                                address,
                                                model)]))]));
   ...
   var decodeAnswers = function () {
      var album = A3($Json$Decode.object2,
      Answer,
      A2($Json$Decode._op[":="],
      "name",
      $Json$Decode.string),
      ...
      "href",
      $Json$Decode.string));
      var answers = $Json$Decode.oneOf(_L.fromArray([A2($Json$Decode.at,
                                                    _L.fromArray(["albums"
                                                                 ,"items"]),
                                                    $Json$Decode.list(album))
                                                    ,A2($Json$Decode.at,
                                                    _L.fromArray(["artists"
                                                                 ,"items"]),
                                                    $Json$Decode.list(album))]));
      ...
      $Json$Decode.oneOf(_L.fromArray([A2($Json$Decode.at,
                                      _L.fromArray(["albums"]),
                                      A2($Json$Decode._op[":="],
                                      "total",
                                      $Json$Decode.$int))
   ...
   var fetchMore = function (model) {
      return function () {
         var _v3 = model.nextUrl;
         switch (_v3.ctor)
         {case "Just":
            return $Effects.task($Task.map(RegisterAnswers)($Task.toMaybe(A2($Http.get,
              decodeAnswers,
      ...
      return function () {
         ...
         {case "AlbumAction":
            switch (action._1.ctor)
              ...
              return function () {
                 var albumsEffects = A2($List.indexedMap,
                 F2(function (j,album) {
                 ...
                 model.albums);
                 var $ = $List.unzip(albumsEffects),
                 albums = $._0,
                 effects = $._1;
                 return {ctor: "_Tuple2"
                        ,_0: _U.replace([["albums"
                                         ,albums]],
                        model)
                        ,_1: A2($Effects.map,
                        AlbumAction(action._0),
            ...
            switch (action._1.ctor)
              ...
              return function () {
                 var artistsEffects = A2($List.indexedMap,
                 F2(function (j,artist) {
                    return _U.eq(action._0,
                    j) ? A2($Artist.update,
                    action._1,
                    artist) : {ctor: "_Tuple2"
                 ...
                 model.artists);
                 var $ = $List.unzip(artistsEffects),
                 artists = $._0,
                 effects = $._1;
                 return {ctor: "_Tuple2"
                        ,_0: _U.replace([["artists"
                                         ,artists]],
                        model)
                        ,_1: A2($Effects.map,
                        ArtistAction(action._0),
                        $Effects.batch(effects))};
              }();
            case "Query":
            return {ctor: "_Tuple2"
            ...
            return function () {
                 var mNewQueryType = queryTypeFromString(action._0);
                 var newQueryType = A2($Maybe.withDefault,
                 model.queryType,
                 mNewQueryType);
                 return {ctor: "_Tuple2"
                        ,_0: _U.replace([["queryType"
                                         ,newQueryType]],
                        model)
                        ,_1: $Effects.none};
              }();
                 ...
                 switch (action._0._0.ctor)
                   {case "_Tuple3":
                      return function () {
                           ...
                           model);
                           return function () {
                              var _v20 = model.queryType;
                              switch (_v20.ctor)
                              {case "QueryAlbum":
                                 return function () {
                                      var toAlbumEffects = F2(function (i,
                                      answer) {
                                         return function () {
                                            var $ = A2($Album.init,
                                            answer.name,
                                            ...
                                            return {ctor: "_Tuple2"
                                                   ,_0: album
                                                   ,_1: A2($Effects.map,
                                                   AlbumAction(i + $List.length(model.albums)),
                                                   effects)};
                                         }();
                                      });
                                      var albumsEffects = A2($List.indexedMap,
                                 ...
                                 case "QueryArtist":
                                 return function () {
                                      var toArtistEffects = F2(function (i,
                                      answer) {
                                         return function () {
                                            var $ = A2($Artist.init,
                                            answer.name,
                                            ...
                                            return {ctor: "_Tuple2"
                                                   ,_0: artist
                                                   ,_1: A2($Effects.map,
                                                   ArtistAction(i + $List.length(model.artists)),
                                                   effects)};
                                         }();
                                      });
                                      var artistsEffects = A2($List.indexedMap,
            ...
            return _U.cmp(action._0,
              10) < 0 && ($Basics.not(model.loading) && isJust(model.nextUrl)) ? {ctor: "_Tuple2"
                                                                                 ,_0: _U.replace([["loading"
                                                                                                  ,true]],
                                                                                 model)
                                                                                 ,_1: fetchMore(model)} : {ctor: "_Tuple2"
                                                                                                          ,_0: model
                                                                                                          ,_1: $Effects.none};}
         _U.badCase($moduleName,
         "between lines 85 and 199");
      }();
   });
   ...
   _elm.Search.values = {_op: _op
                        ...
                        ,queryTypeFromString: queryTypeFromString
                        ,queryTypeToString: queryTypeToString
